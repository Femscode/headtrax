                  ...
                  <div class="d-flex align-items-center mt-lg-6 mt-4">
                     <div class="me-5">
                        ...
                        <div class="d-flex align-items-center mt-2">
                           <img src='{{url("assets/images/avatar/fallback.jpg")}}' alt="Avatar" class="avatar avatar-xs rounded-circle">
                           <div class="ms-2">
                     ...
                     <div>
                        ...
                        <div class="mt-2 text-dark">
                           <span class="fs-6">{{Date('d-m-Y', strtotime($blog->created_at))}}</span>
                        </div>
                     </div>
                  </div>
