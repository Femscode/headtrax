        ...
        <div class="container">
            <div class="row g-7">
                <div class="col-sm-6 col-md-6">
                    ...
                    <div class="px-lg-4">
                        <h2 class="mb-3 h3">Intelligent Customer Support Solutions</h2>
                        <p class="mb-5">
                            Enhance your customer service experience with AI-driven support solutions. Our offerings include:
                        </p>
                        <div class="border-bottom d-flex pb-3 mb-3">
                            <p class="mb-0">
                                <span class="h5">AI-Powered Chatbots :</span>
                                Tailored to support various industries with automated, efficient responses.
                            </p>
                        </div>
                        <div class="border-bottom d-flex pb-3 mb-5">
                            <p class="mb-0">
                                <span class="h5">Automated Ticketing :</span>
                                Reduce response times with automated ticketing systems that prioritize urgent customer queries
                            </p>
                        </div>
                ...
                <div class="col-sm-6 col-md-6">
                    ...
                    <div class="px-lg-4">
                        <h2 class="mb-3 h3">Localized Communication Support</h2>

                        <p class="mb-5">
                            Build stronger connections with your audience by speaking their language—literally.
                        </p>
                        ...
                        <div class="mb-5">
                            <ul class="list-unstyled mb-5">
                                <li class="d-flex mb-2">
                                    ...
                                    <span class="ms-2">Multi-Language Support: Communicate effectively across major local languages, ensuring inclusivity and accessibility.</span>
                                </li>
                                <li class="d-flex mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill text-success mt-1" viewBox="0 0 16 16">
                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                                    </svg>
                                    <span class="ms-2">Cultural Customization: Personalized messaging templates and automated responses that respect and reflect local cultural norms, holidays, and celebrations.</span>
                                </li>

                            </ul>
                        </div>

                        <a href="/contact-us" class="icon-link icon-link-hover">
                            Contact Us
                ...
                <div class="col-sm-6 col-md-6">
                    ...
                    <div class="px-lg-4">
                        ...
                        <a href="/contact-us" class="icon-link icon-link-hover mb-5">
                            Contact Us
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z">
                                </path>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8 col-md-7">
                            <div class="text-center text-md-start mb-6 mb-md-0">
                                <h2 class="text-white-stable">Experience the future of customer engagement with Headtrax Solutions Limited.</h2>
                                <!-- <p class="mb-0 text-dark-50">Plan to building a new website or web app for startup.</p> -->
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-5">
                            <div class="text-center">
                                <a href="/contact-us" class="btn btn-primary">Get Started Today.</a>
                            </div>
                        </div>
                    </div>
                </div>
