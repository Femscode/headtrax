         ...
         <div class="container">
            <div class="row">
               ...
               <h1>Government</h1>
                  ...
                  <h3>Modernizing Citizen Engagement</h3>
                  <p>
                  Empower government services with HeadTrax’s conversational AI. Automate inquiries, streamline processes, and ensure prompt responses to citizen needs. Our solutions make government services accessible, efficient, and reliable. 
                </p>
                 </article>
            </div>
         </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-cue="zoomIn" data-show="true" style="animation-name: zoomIn; animation-duration: 600ms; animation-timing-function: ease; animation-delay: 0ms; animation-direction: normal; animation-fill-mode: both;">
                        <div class="card border-0 card-primary">
                            <div class="card-body p-5">
                                ...
                                <div class="mb-5">
                                    <h4 class="card-title">Automated Citizen Services</h4>
                                    <p class="mb-0 card-text">Streamline service delivery with conversational AI. HeadTrax helps governments automate processes like license renewals, tax inquiries, and appointment scheduling, ensuring efficiency and citizen satisfaction.</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-cue="zoomIn" data-show="true" style="animation-name: zoomIn; animation-duration: 600ms; animation-timing-function: ease; animation-delay: 200ms; animation-direction: normal; animation-fill-mode: both;">
                        <div class="card border-0 card-primary">
                            <div class="card-body p-5">
                                ...
                                <div class="mb-5">
                                    <h4 class="card-title">Proactive Communiction</h4>
                                    <p class="mb-0 card-text">Deliver timely updates, alerts, and notifications to citizens. Whether it’s a public safety alert or an event announcement, our AI ensures that communication is clear and effective.</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-cue="zoomIn" data-show="true" style="animation-name: zoomIn; animation-duration: 600ms; animation-timing-function: ease; animation-delay: 400ms; animation-direction: normal; animation-fill-mode: both;">
                        <div class="card border-0 card-primary">
                            <div class="card-body p-5">
                                ...
                                <div class="mb-5">
                                    <h4 class="card-title">Multilingual Support for Inclusivity</h4>
                                    <p class="mb-0 card-text">Reach diverse populations with multilingual capabilities. HeadTrax facilitates conversations in multiple languages, ensuring that no one is left behind.</p>
                                </div>
        ...
        <div class="container" data-cue="fadeIn" data-show="true" style="animation-name: fadeIn; animation-duration: 600ms; animation-timing-function: ease; animation-delay: 0ms; animation-direction: normal; animation-fill-mode: both;">
            ...
            <div class="row mb-7 pb-4 g-5 text-center text-lg-start">
                <div class="col-md-4" data-cue="fadeIn" data-show="true" style="animation-name: fadeIn; animation-duration: 600ms; animation-timing-function: ease; animation-delay: 0ms; animation-direction: normal; animation-fill-mode: both;">
                    <h4 class="text-white-stable">Improved Citizen Satisfaction</h4>
                    <p class="text-white-50 mb-0">Provide timely, accurate services that meet citizen needs.</p>
                </div>
                <div class="col-md-4" data-cue="fadeIn" data-show="true" style="animation-name: fadeIn; animation-duration: 600ms; animation-timing-function: ease; animation-delay: 200ms; animation-direction: normal; animation-fill-mode: both;">
                    <h4 class="text-white-stable"> Reduced Administrative Workload</h4>
                    <p class="text-white-50 mb-0">Automate repetitive tasks, allowing staff to focus on critical duties.</p>
                </div>
                <div class="col-md-4" data-cue="fadeIn" data-show="true" style="animation-name: fadeIn; animation-duration: 600ms; animation-timing-function: ease; animation-delay: 400ms; animation-direction: normal; animation-fill-mode: both;">
                    <h4 class="text-white-stable">Enhanced Public Engagement</h4>
                    <p class="text-white-50 mb-0">Use personalized communication to build trust with citizens.</p>
                </div>
                <div class="col-md-4" data-cue="fadeIn" data-show="true" style="animation-name: fadeIn; animation-duration: 600ms; animation-timing-function: ease; animation-delay: 400ms; animation-direction: normal; animation-fill-mode: both;">
                    <h4 class="text-white-stable">Cost-Efficient Operations</h4>
                    <p class="text-white-50 mb-0">Reduce operational costs while improving service delivery.</p>
                </div>
                <div class="col-md-4" data-cue="fadeIn" data-show="true" style="animation-name: fadeIn; animation-duration: 600ms; animation-timing-function: ease; animation-delay: 400ms; animation-direction: normal; animation-fill-mode: both;">
                    <h4 class="text-white-stable">Data Security and Compliance</h4>
                    <p class="text-white-50 mb-0">Ensure sensitive data is handled securely and adheres to regulations.</p>
                </div>
            </div>
